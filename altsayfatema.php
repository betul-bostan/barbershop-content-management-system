                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">FİYATLAR</a>
                            </li>
                            <li class="nav-item">
...
/*function mainkismi(){
    echo '<main>
            <div class="container">
                <form action="">
                    <div class="row">
                        <div class="col-md-12 product-list-info">
                            <div class="row quick-filter mt-4">
                                <div class="col">
                                    <span class="text-decoration-underline product-count fw-bold-600"><a href="login.php"> Model Ekle</a></span>
                                </div>
                                <div class="col">
                                    <select name="sort" id="sortSelect" class="sortby float-end">
                                        <option value="1">Yeni Trendler</option>
                                        <option value="2">Klasik Modeller</option>
                                        <option value="3">Sık Kullanılanlar</option>
                                    </select>
                                </div>
                            </div>
